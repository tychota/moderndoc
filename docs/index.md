...
**ModernDoc exists to solve these problems.**
We believe that producing a professional, archival-quality document shouldn't require a degree in TeX programming. You should be able to focus on your content while the system handles the typography.
