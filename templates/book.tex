...
% PREAMBLE
% =============================================================================
\usepackage[book, citestyle=authoryear]{moderndoc}
...
\addtokomafont{chapterprefix}{\headingfont\Large\color{mdocsecondary}}

\renewcommand*{\raggedchapter}{\raggedleft}
\renewcommand*{\chapterformat}{%
  \mbox{\scalebox{2.5}{\color{mdocsecondary}\thechapter}}%
}
...
\renewcommand{\LettrineFontHook}{\headingfont\bfseries}
...
\chapterepigraph{The beginning of wisdom is the definition of terms.}{Socrates}
...
\chapterepigraph{Make things as simple as possible, but not simpler.}{Albert Einstein}
...
\chapterepigraph{The only way to learn a new technique is to practice it.}{Unknown}
...
\begin{center}
  \small
  This book was typeset using LuaLaTeX with the \texttt{moderndoc} style.\\
