...
This template demonstrates the capabilities of the \texttt{modern-doc} style
...
\begin{itemize}
  ...
  \item Code snippets via \texttt{codeblock} (minted when enabled)
...
Inline code looks like this: \code{def hello(): print("Hello")}.

For code blocks, use the \texttt{codeblock} environment:
...
The \texttt{modern-doc} package provides semantic markup commands:
